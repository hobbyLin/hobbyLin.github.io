...
(function($) {
    $.fn.orbit = function(options) {
      ...
      backendHeight: 120, //backend Img Height 1
      ...
      backendHeight2: 90, //backend Img Height 2
      ...
      slides.eq(activeSlide)
      	.css({"z-index" : numberSlides , left:options.frontendLeft , "width": options.frontendWidth+"px","height": options.frontendHeight+"px", top: 0,"border":options.frontendBorder})
      	.fadeIn(function() {
      		slides.eq(activeSlide).siblings().css({"width": options.backendWidth+"px","height": options.backendHeight+"px",top:options.backendTop});
			
      	});
		slides.eq((activeSlide-2)%numberSlides).css({"left":options.backendLeft2,"z-index" : numberSlides-2,"top":options.backendTop2,"width": options.backendWidth2+"px","height": options.backendHeight2+"px","border":options.backendBorder2});
		slides.eq((activeSlide-1)%numberSlides).css({"left":options.backendLeft,"z-index" : numberSlides-1,"top":options.backendTop,"width": options.backendWidth+"px","height": options.backendHeight+"px","border":options.backendBorder});
		slides.eq((activeSlide)%numberSlides).css({"left":options.frontendLeft,"z-index" : numberSlides, "width": options.frontendWidth+"px","height": options.frontendHeight+"px", top: 0});
		slides.eq((activeSlide+1)%numberSlides).css({"left":options.backendLeft3,"z-index" : numberSlides-1,"top":options.backendTop,"width": options.backendWidth+"px","height": options.backendHeight+"px","border":options.backendBorder});
		slides.eq((activeSlide+2)%numberSlides).css({"left":options.backendLeft4,"z-index" : numberSlides-2,"top":options.backendTop2,"width": options.backendWidth2+"px","height": options.backendHeight2+"px","border":options.backendBorder2});
   ...
   /* for(act = 1;act<numberSlides;act++){
      	...
      	slides.eq((activeSlide+act)%numberSlides).css({"z-index" : numberSlides-1});
			...
			if(slideDirection == "next") {
                  ...
                  .animate({"left" : options.frontendLeft+"px" , "width": options.frontendWidth+"px" ,"height": options.frontendHeight+"px" , "top": "0px"}, options.animationSpeed, resetAndUnlock);
				          slides
                	.eq(prevActiveSlide).css({"z-index" : numberSlides-1 ,"border": options.backendBorder})
                	.animate({"left" : options.backendLeft, "width": options.backendWidth+"px","height": options.backendHeight+"px",top:options.backendTop+"px"}, options.animationSpeed);
                slides
                	.eq(prevActiveSlide1).css({"z-index" : numberSlides-2 ,"border": options.backendBorder2})
                	.animate({"left" : "0px", "width": options.backendWidth2+"px","height": options.backendHeight2+"px",top:options.backendTop2+"px"}, options.animationSpeed);
                slides
                	.eq(nextActiveSlide).css({"z-index" : numberSlides-1 ,"border": options.backendBorder})
                	.animate({"left" : options.backendLeft3+"px", "width": options.backendWidth+"px","height": options.backendHeight+"px",top:options.backendTop+"px"}, options.animationSpeed);
                 slides
                	.eq(nextActiveSlide1).css({"z-index" : numberSlides-2 ,"border": options.backendBorder2})
                	.animate({"left" : options.backendLeft4+"px", "width": options.backendWidth2+"px","height": options.backendHeight2+"px",top:options.backendTop2+"px"}, options.animationSpeed);
                /*slides
